...
<Info>
You don't necessarily need to subscribe to the instance right now, since you have 2 days to use it as a trial. After 2 days without a subscription, the instance's status is changed to PENDING, and it remains listed until it is subscribed.
</Info>
